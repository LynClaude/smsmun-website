      ...
      <div>
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    >
                      <Image
                        ...
                        alt={`PPRDMUN 2016 Photo ${currentImageIndex + 1}`}
                        fill
        ...
        <div className="bg-gray-50 py-24">
          <div className="container mx-auto px-4">
            ...
            <InvitationLetter
              year={2016}
              title="PPRDMUN 2016 邀请函"
              description="深中模联十一年，泛珠模联第七次绽放"
              href="/pprdmun/2016/letter"
            />
          </div>
        </div>
