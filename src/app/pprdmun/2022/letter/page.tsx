...
export default function PPRDMUN2022LetterPage() {
  const content = `
    ...
    <p class="mb-6">
      十二载笃行不辍,十二载踵事增华。身为模联人，我们长怀理想主义之热忱，奋逐独立自由之远方，执守学术至上之理念，肩负青年之使命与公民之责任。过去的十二年中，我们乘时代的浪潮不断前行，菁华，踔厉风发。延续过往十二年的泛珠模联筹办理念，我们审视自身，革旧立新。贰贰年初始，国际政治风云变幻，带领人们重新思考战争与和平，自由与民主之真章。回到二十一世纪的前夜，我们重新审视前南斯拉夫解体后，发生在波黑土地之上的独立内战。世界的注视与干预之下，鲜血写就的历史究竟带来自由的空气，还是刺伤了土地上的芸芸众生?自一九年疫情初始已是两年光景，经济发展与公共卫生间的平衡成为全球议题，立而今之时代，我们回望经济大萧条的黑暗时期，站上国际劳工大会的会场,失业的浪潮席卷而来,无数劳工将何去何从?转换视角，我们将目光置于人类欲望与其管制背后的黑暗，酒精这一从千百年前就写进人类诗篇与历史的符号，它的严格禁令下是否有黑色交易暗中滋生?站在时光的不远处，我们愿不仅求索每一个事实背后的可能，更以史为镜而照今朝。
    </p>
    <p class="mb-6">
