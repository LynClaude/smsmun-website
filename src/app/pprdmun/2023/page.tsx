...
export default function PPRDMUN2023Page() {
      ...
      <div>
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    >
                      <Image
                        ...
                        alt={`PPRDMUN 2023 Photo ${currentImageIndex + 1}`}
                        fill
        ...
        <div className="bg-gray-50 py-24">
          <div className="container mx-auto px-4">
            ...
            <InvitationLetter
              year={2023}
              title="PPRDMUN 2023 邀请函"
              description="生机盎然，疫情消散，十四载泛珠模联再聚凤凰花下"
              href="/pprdmun/2023/letter"
            />
          </div>
        </div>
          ...
          <div className="container mx-auto px-4">
            <div className="space-y-16">
              ...
              <div className="bg-gray-50 p-8 rounded-xl shadow-lg space-y-6">
                <h3 className="text-3xl font-bold text-primary">1982 马尔维纳斯群岛危机协调机制（1982 Coordination Mechanism for the Malvinas War）</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    <h4 className="text-xl font-semibold">会场设置</h4>
                    <ul className="space-y-2 text-gray-600">
                      <li>• 1982 马尔维纳斯群岛危机安理会特别会场(UNSC)</li>
                      <li>• 英阿谈判会议(BANC)</li>
                      <li>• 主新闻中心(MPC)</li>
                    </ul>
                  </div>
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-600">
                      1982年马尔维纳斯群岛危机协调机制，回望二十世纪，冷战之威胁无孔不入地在国际事务中渗透，审视着马岛上空呼啸的敌意与冰冷的炮火，英阿争端的背后暗藏的究竟是历史与现实的利益沟壑，还是民族主义与国际格局间的对抗？
                    </p>
                  </div>
                </div>
              </div>

              {/* 2023 The 66th session of the Committee on the Peaceful Uses of Outer Space */}
              <div className="bg-gray-50 p-8 rounded-xl shadow-lg space-y-6">
                <h3 className="text-3xl font-bold text-primary">2023 The 66th session of the Committee on the Peaceful Uses of Outer Space（CoPUos）</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    <h4 className="text-xl font-semibold">会场设置</h4>
                    <ul className="space-y-2 text-gray-600">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-xl font-semibold">议题背景</h4>
                    <p className="text-gray-600">
                      2023年第66届和平利用外层空间委员会会议，立而今之时代，当军备竞赛的脚步进一步踏出地球迈向太空，当边疆愈发伸向无人的宇宙、企图在外层空间肆意延拓，那深邃无垠的黑暗之中又潜伏着怎样的危机与挑战？
                    </p>
                  </div>
                </div>
              </div>
