...
VALUES ('test-claude-id', 'Claude', 'claude@example.com', true, true, '2023', false, NOW())
...
VALUES 
  ('claude-001', 'test-claude-id', 'Claude', 'claude@example.com', '2023', '技术顾问', 
   '在深中模联期间担任技术部长，负责网站开发和维护', 
   '希望为协会提供技术支持和指导', 
   '每周2-3小时，可参与线上指导会议', 
   '熟悉Web开发、数据库管理等技术领域', 
   'approved', NOW()),
  ('zhangsan-002', 'test-claude-id', '张三', 'zhangsan@example.com', '2022', '学术顾问', 
